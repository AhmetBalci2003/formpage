...
{
    /// <inheritdoc />
    public partial class AddFiyat2ToOteller : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    No_1_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_1_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no1_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no2 = table.Column<bool>(type: "bit", nullable: false),
                    No_2_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_2_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no2_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no3 = table.Column<bool>(type: "bit", nullable: false),
                    No_3_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_3_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no3_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no4 = table.Column<bool>(type: "bit", nullable: false),
                    No_4_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_4_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no4_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no5 = table.Column<bool>(type: "bit", nullable: false),
                    No_5_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_5_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no5_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no6 = table.Column<bool>(type: "bit", nullable: false),
                    No_6_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_6_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no6_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no7 = table.Column<bool>(type: "bit", nullable: false),
                    No_7_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_7_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no7_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no8 = table.Column<bool>(type: "bit", nullable: false),
                    No_8_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_8_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no8_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no9 = table.Column<bool>(type: "bit", nullable: false),
                    No_9_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_9_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no9_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no10 = table.Column<bool>(type: "bit", nullable: false),
                    No_10_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_10_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no10_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no11 = table.Column<bool>(type: "bit", nullable: false),
                    No_11_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_11_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no11_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no12 = table.Column<bool>(type: "bit", nullable: false),
                    No_12_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_12_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no12_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no13 = table.Column<bool>(type: "bit", nullable: false),
                    No_13_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_13_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no13_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no14 = table.Column<bool>(type: "bit", nullable: false),
                    No_14_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_14_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no14_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no15 = table.Column<bool>(type: "bit", nullable: false),
                    No_15_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_15_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no15_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no16 = table.Column<bool>(type: "bit", nullable: false),
                    No_16_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_16_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no16_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no17 = table.Column<bool>(type: "bit", nullable: false),
                    No_17_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_17_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no17_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no18 = table.Column<bool>(type: "bit", nullable: false),
                    No_18_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_18_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no18_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no19 = table.Column<bool>(type: "bit", nullable: false),
                    No_19_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_19_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Oda_no19_user = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Oda_no20 = table.Column<bool>(type: "bit", nullable: false),
                    No_20_giris = table.Column<DateTime>(type: "datetime2", nullable: true),
                    No_20_cıkıs = table.Column<DateTime>(type: "datetime2", nullable: true),
